package com.camellia.squirrelyouxuan.user.controller;
...
import com.camellia.squirrelyouxuan.user.util.HttpClientUtils;
import com.camellia.squirrelyouxuan.user.util.WeiXinProperties;
...
public class WeiXinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        //// 使用HttpClient工具请求
        //小程序id
        String wxOpenAppId = WeiXinProperties.WX_OPEN_APP_ID;
        //小程序秘钥
        String wxOpenAppSecret = WeiXinProperties.WX_OPEN_APP_SECRET;
        //get请求
        //拼接请求地址+参数
        ...
        try {
            ...
            throw new SquirrelYouXuanException(ResultCodeEnum.FETCH_OPENID_SESSIONKEY_FAILD);
        }
        ...
        //5 根据userId查询收货地址信息
        UserAddressVo UserAddressVo =  userService.getAddressByUserId(user.getId());
        ...
        map.put("user", user);
        map.put("token", token);
        map.put("userAddressVo", UserAddressVo);
